...
#define LOG_PRINTF(...) do{ \
    ...
    if(_len > 0) { \
        DAQ_Inter->SendLog(_msg_log,ToolFramework::LogLevel::Warning); \
...
#define DEBUG_PRINTF_1(...) do{ \
    ...
    if(debug_flag >=1) { \
        ...
        int _len = snprintf(_msg_log, sizeof(_msg_log), __VA_ARGS__); \
        if(_len > 0) { \
            DAQ_Inter->SendLog(_msg_log,ToolFramework::LogLevel::Debug); \
...
#define DEBUG_PRINTF_2(...) do{ \
    ...
    if(debug_flag >=2) { \
        ...
        int _len = snprintf(_msg_log, sizeof(_msg_log), __VA_ARGS__); \
        if(_len > 0) { \
            DAQ_Inter->SendLog(_msg_log,ToolFramework::LogLevel::Debug1); \
...
struct config_element config_variables[] = {
    ...
    {"Dig0", "calib", ENV_PARAM, "SET_DIG0_CALIBEN", 0},
    {"Dig0", "calibtype", ENV_PARAM, "SET_DIG0_CALIBTYPE", 0},
    ...
    {"Dig0", "calibgain", ENV_PARAM, "SET_DIG0_CALIBGAIN", 0},
    ...
    {"Dig1", "calib", ENV_PARAM, "SET_DIG1_CALIBEN", 0},
    {"Dig1", "calibtype", ENV_PARAM, "SET_DIG1_CALIBTYPE", 0},
    ...
    {"Dig1", "calibgain", ENV_PARAM, "SET_DIG1_CALIBGAIN", 0},
